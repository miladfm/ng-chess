// import { MovementDirection, PieceType, PieceColor, SquareId, StoreService, PieceMovement } from '@chess/core';
...
export class Piece {
  ...
  //     let index = 1;
  //     // TODO: Write a short text, that is this loop about
  //     while (index <= maxMovement && this.store.isSquareValid(`${nextCol}${nextRow}`)) {
  //
